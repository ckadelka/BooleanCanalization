...
def get_layer_format(inputfile,outputfile,method=find_layers.find_layers):
...
option = 'real'
inputfile = 'input/testfiles_table_nmin%i_nmax%i_nstep%i_%s_seed%i.txt' % (n_min,n_max,n_step,option,seed)
outputfile = 'output/testfiles_table_nmin%i_nmax%i_nstep%i_%s_seed%i_find_layers.txt' % (n_min,n_max,n_step,option,seed)
get_layer_format(inputfile,outputfile,method=find_layers.find_layers)
