...
def generate_testfiles(n_min=2,n_max=16,n_step=2,nsim=5,option='kmin0',EXACT_DEPTH_K=False,seed=0):
...
if __name__ == '__main__':
    #generate testfiles
    generate_testfiles(n_min=n_min,n_max=n_max,n_step=n_step,nsim=nsim,option=option,EXACT_DEPTH_K=EXACT_DEPTH_K,seed=seed)
